...
function displayData() {
    let container = ``
    myArray.map((info) => container += ` <div class="col-lg-3 col-md-6 mb-3">
    <div class="surgery-items position-relative">
        <img src=${info.img} class="w-100" alt="">
        <div class="surgey-layer position-absolute d-flex justify-content-between align-items-end px-3">
